...
public class Grupo implements Serializable {
	...
	@Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sequence_grupo")
	@SequenceGenerator(name =  "sequence_grupo", sequenceName = "sequence_grupo", initialValue = 1, allocationSize = 1)
	private Long codigo;
