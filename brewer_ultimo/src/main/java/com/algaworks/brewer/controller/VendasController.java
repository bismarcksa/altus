...
import com.algaworks.brewer.services.VendaService;
...
public class VendasController {
   ...
   @GetMapping
    public ModelAndView pesquisar(@Validated VendaFilter vendaFilter, BindingResult result, @PageableDefault(size = 10) Pageable pageable, HttpServletRequest httpServletRequest) {
...
//        venda = cadastroVendaService.salvar(venda);
	...
	@PostMapping("/item")
    public ModelAndView adicionarItem(@RequestParam("codigoCerveja") Cerveja cerveja, @RequestParam("uuid") String uuid) {  		
    		tabelaItens.adicionarItem(uuid, cerveja, 1);
        return getModelAndViewTabelaItens(uuid);
    }

   @PutMapping("/item/{codigoCerveja}")
   public ModelAndView alterarQuantidadeItem(@PathVariable("codigoCerveja") Cerveja cerveja, @RequestParam("quantidade") Integer quantidade, @RequestParam("uuid") String uuid){	   
    ...
    public ModelAndView cancelar(@P("venda") Venda venda, RedirectAttributes attributes, BindingResult result, @AuthenticationPrincipal UsuarioSistema usuarioSistema) {      
