...
@NamedQueries({ 
	@NamedQuery(name = "Configuracoes.listar", query = "SELECT configuracoes FROM Configuracoes configuracoes"),
	@NamedQuery(name = "Configuracoes.buscarPorCodigo", query = "SELECT configuracoes FROM Configuracoes configuracoes WHERE configuracoes.codigo = :codigo"),
})
public class Configuracoes {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sequence_id_configuracoes")
	@SequenceGenerator(name =  "sequence_id_configuracoes", sequenceName = "sequence_configuracoes", initialValue = 1, allocationSize = 1)
	@Column(name = "con_codigo")
	private Long codigo;

	@Column(name = "con_limite_diario_sache", nullable = false)
	private Long limiteDiarioSache;
	
	@Column(name = "con_limite_diario_capsula", nullable = false)
	private Long limiteDiarioCapsula;
	
	@Column(name = "con_limite_diario_shake", nullable = false)
	private Long limiteDiarioShake;
	
	@Column(name = "con_limite_diario_envase", nullable = false)
	private Long limiteDiarioEnvase;
	
	@Column(name = "con_bloquear_lancamento_producao")
	private Date bloquearLancamentoProducao;
	
	@Column(name = "con_bloquear_lancamento_producao2")
	private Date bloquearLancamentoProducao2;
	
	@Column(name = "con_bloquear_lancamento_producao3")
	private Date bloquearLancamentoProducao3;
	
	@Column(name = "con_bloquear_lancamento_producao_sache")
	private Boolean bloquearLancamentoProducaoItemSache;
	
	@Column(name = "con_bloquear_lancamento_producao_capsula")
	private Boolean bloquearLancamentoProducaoItemCapsula;
	
	@Column(name = "con_bloquear_lancamento_producao_shake")
	private Boolean bloquearLancamentoProducaoItemShake;
	
	@Column(name = "con_bloquear_lancamento_producao_envase")
	private Boolean bloquearLancamentoProducaoItemEnvase;
	
	@Column(name = "con_bloquear_lancamento_producao2_sache")
	private Boolean bloquearLancamentoProducao2ItemSache;
	
	@Column(name = "con_bloquear_lancamento_producao2_capsula")
	private Boolean bloquearLancamentoProducao2ItemCapsula;
	
	@Column(name = "con_bloquear_lancamento_producao2_shake")
	private Boolean bloquearLancamentoProducao2ItemShake;
	
	@Column(name = "con_bloquear_lancamento_producao2_envase")
	private Boolean bloquearLancamentoProducao2ItemEnvase;
	
	@Column(name = "con_bloquear_lancamento_producao3_sache")
	private Boolean bloquearLancamentoProducao3ItemSache;
	
	@Column(name = "con_bloquear_lancamento_producao3_capsula")
	private Boolean bloquearLancamentoProducao3ItemCapsula;
	
	@Column(name = "con_bloquear_lancamento_producao3_shake")
	private Boolean bloquearLancamentoProducao3ItemShake;
	
	@Column(name = "con_bloquear_lancamento_producao3_envase")
	private Boolean bloquearLancamentoProducao3ItemEnvase;
	
	@Column(name = "con_ano_base", nullable = false)
	private Long anoBase;
	
	@Column(name = "con_meta67", nullable = false)
	private Long meta67;
	
	@Column(name = "con_meta68", nullable = false)
	private Long meta68;
	
	@Column(name = "con_meta70", nullable = false)
	private Long meta70;
	...
	public Long getMeta67() {
		return meta67;
	}

	public void setMeta67(Long meta67) {
		this.meta67 = meta67;
	}

	public Long getMeta68() {
		return meta68;
	}

	public void setMeta68(Long meta68) {
		this.meta68 = meta68;
	}

	public Long getMeta70() {
		return meta70;
	}

	public void setMeta70(Long meta70) {
		this.meta70 = meta70;
	}
	...
	public String toString() {
		return "Configuracoes [codigo=" + codigo + ", limiteDiarioSache=" + limiteDiarioSache + ", limiteDiarioCapsula="
				+ limiteDiarioCapsula + ", limiteDiarioShake=" + limiteDiarioShake + ", limiteDiarioEnvase="
				+ limiteDiarioEnvase + ", bloquearLancamentoProducao=" + bloquearLancamentoProducao
				+ ", bloquearLancamentoProducao2=" + bloquearLancamentoProducao2 + ", bloquearLancamentoProducao3="
				+ bloquearLancamentoProducao3 + ", bloquearLancamentoProducaoItemSache="
				+ bloquearLancamentoProducaoItemSache + ", bloquearLancamentoProducaoItemCapsula="
				+ bloquearLancamentoProducaoItemCapsula + ", bloquearLancamentoProducaoItemShake="
				+ bloquearLancamentoProducaoItemShake + ", bloquearLancamentoProducaoItemEnvase="
				+ bloquearLancamentoProducaoItemEnvase + ", bloquearLancamentoProducao2ItemSache="
				+ bloquearLancamentoProducao2ItemSache + ", bloquearLancamentoProducao2ItemCapsula="
				+ bloquearLancamentoProducao2ItemCapsula + ", bloquearLancamentoProducao2ItemShake="
				+ bloquearLancamentoProducao2ItemShake + ", bloquearLancamentoProducao2ItemEnvase="
				+ bloquearLancamentoProducao2ItemEnvase + ", bloquearLancamentoProducao3ItemSache="
				+ bloquearLancamentoProducao3ItemSache + ", bloquearLancamentoProducao3ItemCapsula="
				+ bloquearLancamentoProducao3ItemCapsula + ", bloquearLancamentoProducao3ItemShake="
				+ bloquearLancamentoProducao3ItemShake + ", bloquearLancamentoProducao3ItemEnvase="
				+ bloquearLancamentoProducao3ItemEnvase + ", anoBase=" + anoBase + ", meta67=" + meta67 + ", meta68="
				+ meta68 + ", meta70=" + meta70 + "]";
	}
