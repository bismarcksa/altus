...
@Entity
@Table(name = "tbl_metas_loja67")
@NamedQueries({ 
	@NamedQuery(name = "MetasLoja67.listar", query = "SELECT metasLoja67 FROM MetasLoja67 metasLoja67 ORDER BY metasLoja67.codigo"),	
	@NamedQuery(name = "MetasLoja67.buscarPorCodigo", query = "SELECT metasLoja67 FROM MetasLoja67 metasLoja67 WHERE metasLoja67.codigo = :codigo")
})
public class MetasLoja67 {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sequence_id_metas_loja67")
	@SequenceGenerator(name =  "sequence_id_metas_loja67", sequenceName = "sequence_metas_loja67", initialValue = 1, allocationSize = 1)
	@Column(name = "codigo")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		MetasLoja67 other = (MetasLoja67) obj;
		return Objects.equals(codigo, other.codigo);
	}

	@Override
	public String toString() {
		return "MetasLoja67 [codigo=" + codigo + ", ano=" + ano + ", mes=" + mes + ", meta=" + meta + ", vendas="
				+ vendas + ", percentual=" + percentual + "]";
	}
