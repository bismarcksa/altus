...
@Entity
@Table(name = "tbl_indicadores_cortesia")
@NamedQueries({ 
	@NamedQuery(name = "IndicadoresCortesia.listar", query = "SELECT indicadoresCortesia FROM IndicadoresCortesia indicadoresCortesia ORDER BY indicadoresCortesia.codigo ASC"),
	@NamedQuery(name = "IndicadoresCortesia.buscarPorCodigo", query = "SELECT indicadoresCortesia FROM IndicadoresCortesia indicadoresCortesia WHERE indicadoresCortesia.codigo = :codigo")
})
public class IndicadoresCortesia {

	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "sequence_id_indicadores_cortesia")
	@SequenceGenerator(name =  "sequence_id_indicadores_cortesia", sequenceName = "sequence_indicadores_cortesia", initialValue = 1, allocationSize = 1)
	@Column(name = "codigo")
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		IndicadoresCortesia other = (IndicadoresCortesia) obj;
		return Objects.equals(codigo, other.codigo);
	}

	@Override
	public String toString() {
		return "IndicadoresCortesia [codigo=" + codigo + ", ano=" + ano + ", janeiro=" + janeiro + ", fevereiro=" + fevereiro
