...
public class Relatorio {
    ...
    public void getRelatorio(List<ControlePontoDetalhe> lista, Long codigoFuncionario, String totalBancoHorasMesTexto) {
        stream = this.getClass().getResourceAsStream("/Relatorio/ControlePonto.jasper");
        ...
        params.put("codigoFuncionario", codigoFuncionario); // Passando o parâmetro exigido pelo relatório
        params.put("totalBancoHorasMesTexto", totalBancoHorasMesTexto); // Passando o parâmetro exigido pelo relatório
        ...
        try {
            ...
            response.setHeader("Content-disposition", "inline; filename=ControlePonto.pdf");
