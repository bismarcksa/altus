...
public class RelatorioBairro {
    ...
    private static final Logger logger = Logger.getLogger(RelatorioBairro.class);

    public RelatorioBairro() {
        this.context = FacesContext.getCurrentInstance();
        this.response = (HttpServletResponse) context.getExternalContext().getResponse();
    }

    public void getRelatorioBairro(List<Bairro> lista) {
        stream = this.getClass().getResourceAsStream("/Relatorio/Bairro.jasper");
...
//        params.put("codigoFuncionario", codigoFuncionario); // Passando o parâmetro exigido pelo relatório
        ...
        try {
            ...
            response.setHeader("Content-disposition", "inline; filename=Bairro.pdf");
